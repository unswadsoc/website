    ...
    <footer className="footer p-10 bg-neutral text-neutral-content">
      ...
      <div>
        ...
        <div className="flex gap-4">
          <a href='https://www.facebook.com/UNSWadsoc' target='_blank' rel='noopener noreferrer' className='hover:cursor-pointer'>
          ...
          <a href='https://www.instagram.com/unswadsoc/' target='_blank' rel='noopener noreferrer' className='hover:cursor-pointer'>
